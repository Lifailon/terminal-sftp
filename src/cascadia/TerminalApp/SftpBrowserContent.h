...
#pragma endregion
    ...
    private:
        ...
        winrt::Windows::UI::Xaml::Controls::MenuFlyout _contextMenu{ nullptr };
        ...
        void _upClick(const winrt::Windows::Foundation::IInspectable& sender, const winrt::Windows::UI::Xaml::RoutedEventArgs& e);
        ...
        void _openInVSCodeClick(const winrt::Windows::Foundation::IInspectable& sender, const winrt::Windows::UI::Xaml::RoutedEventArgs& e);
        ...
        void _pathBoxKeyDown(const winrt::Windows::Foundation::IInspectable& sender, const winrt::Windows::UI::Xaml::Input::KeyRoutedEventArgs& e);
